...
export function HeaderMegaMenu({ logo, showThemeToggle, showSearchIcon, showAuthButtons, showUserProfileAvatar, navLink }: HeaderMegaMenuLayoutProps) {
...
export const HeaderMegaMenuLayout = qwikify$<HeaderMegaMenuLayoutProps>(HeaderMegaMenu);

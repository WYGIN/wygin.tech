...
export const category_followers = mysqlTable(
  "category_followers",
  {
  ...
  (table) => {
    return {
      unique__category_id__user_id: uniqueIndex(
        "unique__publication_id__user_id"
      ).on(table.category_id, table.user_id),
...
export const category_follower__relations = relations(
  category_followers,
  ({ one }) => ({
...
export const insert__category_followers = createInsertSchema(
  category_followers,
  {
...
export const select__category_followers =
  createSelectSchema(category_followers);

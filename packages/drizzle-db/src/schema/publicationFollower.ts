...
export const publication_followers = mysqlTable(
  ...
  (table) => {
    return {
      unique__publication_id__user_id: uniqueIndex(
        "unique__publication_id__user_id"
      ).on(table.publication_id, table.user_id),
      index__publication_id: index("index__publication_id").on(
...
export const publication_follower__relations = relations(
  publication_followers,
  ({ one }) => ({
...
export const insert__publication_followers = createInsertSchema(
  publication_followers,
  {
...
export const select__publication_followers = createSelectSchema(
  publication_followers
);
